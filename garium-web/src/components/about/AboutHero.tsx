        ...
        <AnimatedSection>
          <div className="max-w-[680px]">
            ...
            <h1 className="font-semibold text-white text-balance mb-6" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1', letterSpacing: '-0.025em' }}>
              Named after garri. Built to last.
            </h1>
            <p className="text-white/70 text-xl leading-relaxed">
              Garium is a private AI infrastructure company owned by Conqolx Technologies Company, serving organisations that believe their data belongs to them.
            </p>
          </div>
        </AnimatedSection>
      </div>
