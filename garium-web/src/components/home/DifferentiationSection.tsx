    ...
    <section className="section-pad" style={{ background: 'linear-gradient(180deg, #081c52 0%, #040e2e 100%)' }}>
      <div className="container-garium">
        <AnimatedSection>
          <div className="max-w-[720px] mx-auto text-center mb-10">
            ...
            <p className="text-white/90 text-lg leading-relaxed">
              Microsoft Copilot costs $30 per person per month. A team of 50 pays $18,000 per year — and Microsoft still has your data. Garium&apos;s Grow plan is $750 per month flat. No per-seat charges. The more people who use it, the better the economics get.
            </p>
          </div>
        </AnimatedSection>
        ...
        <AnimatedSection delay={0.1}>
          <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-10 max-w-[600px] mx-auto">
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-white/20">
                  <th className="text-left py-3 px-4 text-white/60 font-medium w-1/2" scope="col"></th>
